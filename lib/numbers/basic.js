...
/**
  ...
  */
basic.is_int = function(value) {
  return typeof value === 'number' && !isNaN(parseInt(value,10)) && (parseFloat(value,10) == parseInt(value,10));
}
...
basic.divmod = function(a, b) {
  if(!basic.is_int(a) || !basic.is_int(b)) return [-1, -1];
...
/**
  ...
  * @return {Array} [div, mod]
  */
// basic.perfect_power = function(n) {
//   //TODO
// }

// basic.power_mod = function(a, b, m) {
