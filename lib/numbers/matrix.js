...
matrix.lupDecomposition = function(arr) {
    ...
    this.swapRows = function(m, firstRowIndex, secondRowIndex) {
        var temp = m[firstRowIndex];
        m[firstRowIndex] = m[secondRowIndex];
        m[secondRowIndex] = temp;
    };
    ...
    for (var j = 0; j < size; j++) {
        ...
        if (pivot != j) {
            this.swapRows(LU, pivot, j);
            this.swapRows(P, pivot, j);
        }
