...
/**
 * Raises this complex number to the nth power where n is positive
 * and greater than one.
 *
 * @param n power to raise this complex number to.
...
Complex.prototype.pow = function(n) {
  ...
  return new Complex(constant * Math.cos(n * this.phase()),
                     constant * Math.sin(n * this.phase()));
};
