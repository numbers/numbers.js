 ...
 * @return {Matrix} The updated Matrix
 */
Matrix.prototype.swapElements = function(col1, row1, col2, row2) {
  var elem1 = this.getElement(col1, row1),
      elem2 = this.getElement(col2, row2);
  
  this.setElement(col1, row1, elem2).setElement(col2, row2, elem1);
